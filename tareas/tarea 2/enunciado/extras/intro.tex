...
Para acceder a su repositorio privado debe ingresar al siguiente \href{https://classroom.github.com/a/Q5wA8A-J}{link}, seleccionar su nombre y aceptar la invitación.
...
.3 \faFileCodeO \ \texttt{pregunta1\_a.ipynb}.
.3 \faFilePdfO \ \texttt{1\_b\_c.pdf}.  
.2 \faFolderOpenO \ Pregunta\_2.
.3 \faFileTextO \ \texttt{requirements.txt}.  
.3 \faFileCodeO \ \texttt{pregunta2.ipynb}.
