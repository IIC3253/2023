...
.2 \faFolderOpenO \ \texttt{Pregunta\_1}.
.3 \faFolderOpenO \ <numero\_alumno>.
.4 \faFileO \ \texttt{0.bin}.
.4 \faFileO \ \texttt{1.bin}.
.4 \faFileO \ \texttt{2.bin}.
.4 \faFileO \ \texttt{3.bin}.
.4 \faFileO \ \texttt{4.bin}.
.4 \faFileO \ \texttt{5.bin}.
.4 \faFileO \ \texttt{6.bin}.
.4 \faFileO \ \texttt{7.bin}.
.3 \faFileTextO \ \texttt{requirements.txt}.
.3 \faFileCodeO \ \texttt{pregunta1.ipynb}.
.3 \faFileO \ \texttt{key.bin}.
.2 \faFolderOpenO \ \texttt{Pregunta\_2}.
.3 \faFilePdfO \ \texttt{pregunta2.pdf}.
.2 \faFolderOpenO \ \texttt{Pregunta\_3}.
.3 \faFilePdfO \ \texttt{pregunta3.pdf}.
.2 \faFolderOpenO \ \texttt{Pregunta\_4}.
.3 \faFilePdfO \ \texttt{pregunta4.pdf}.
